    ...
    return (
      <div>
        ...
        <div className="page-header ">
          <h3 className="page-title wrapper-dashboard p-3">
            <span className="page-title-icon bg-gradient-primary text-white mr-2">
              <i className="mdi mdi-home"></i>
            </span> Dashboard </h3>
          <nav aria-label="breadcrumb">
            <ul className="breadcrumb">
              <li className="breadcrumb-item active wrapper-dashboard p-3" aria-current="page">
        ...
        <div className="row">
          <div className="col-md-4 stretch-card grid-margin ">
            <div className="card bg-gradient-danger wrapper-dashboard card-img-holder text-black">
          ...
          <div className="col-md-4 stretch-card grid-margin">
            <div className="card bg-gradient-info wrapper-dashboard card-img-holder text-black">
              <div className="card-body">
                <img src={require("../../assets/images/dashboard/circle.svg")} className="card-img-absolute" alt="circle" />
          ...
          <div className="col-md-4 stretch-card grid-margin">
            <div className="card bg-gradient-success wrapper-dashboard card-img-holder text-black">
              <div className="card-body">
                <img src={require("../../assets/images/dashboard/circle.svg")} className="card-img-absolute" alt="circle" />
