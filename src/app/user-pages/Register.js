              ...
              <div className="auth-form-light text-left py-5 px-4 px-sm-5">
                ...
                <form className="pt-3">
                  ...
                  <div className="mt-3">
                    ...
                    <Link className="btn btn-block btn-primary-c btn-lg font-weight-medium auth-form-btn" to="/dashboard">SIGN UP</Link>
                  </div>
                  <div className="text-center mt-4 font-weight-light">
                    Already have an account? <Link to="/user-pages/login-1" className="text-primary-c">Login</Link>
                  </div>
                </form>
              </div>
            </div>
