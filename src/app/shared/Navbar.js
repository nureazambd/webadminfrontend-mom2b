    ...
    return (
      <nav className="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div className="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <Link className="navbar-brand brand-logo" to="/"><img src={require('../../assets/images/Mom2B-Logo-1-2.svg')} alt="logo" /></Link>
          <Link className="navbar-brand brand-logo-mini navbar-brand-logo-colore" to="/"><img src={require('../../assets/images/mom2bLogo-removebg1-1.png')} alt="logo" /></Link>
        </div>
        <div className="navbar-menu-wrapper d-flex align-items-stretch">
          ...
          <ul className="navbar-nav navbar-nav-right">
              ...
              <Dropdown alignRight>
                <Dropdown.Toggle className="nav-link">
                  ...
                  <div className="nav-profile-text">
                    <p className="mb-1 text-black"><Trans>Shah Rukh Khan</Trans></p>
                  </div>
                </Dropdown.Toggle>
                ...
                <Dropdown.Menu className="navbar-dropdown">
                  ...
                  <Dropdown.Item href="!#" onClick={evt =>evt.preventDefault()}>
                    ...
                    <Link to="/login"><Trans>Signout</Trans></Link>
                  </Dropdown.Item>

                  <Dropdown.Item href="!#" onClick={evt =>evt.preventDefault()}>
                    <i className="mdi mdi-brightness-7 mr-2 text-primary"></i>
                    <Link to="/settings"><Trans>User Settings</Trans></Link>
                  </Dropdown.Item>
                </Dropdown.Menu>
              </Dropdown>
            </li>
            ...
            <li className="nav-item nav-logout d-none d-lg-block">
              {/* <Link className="nav-link" to="/login-page" onClick={event => event.preventDefault()}>
